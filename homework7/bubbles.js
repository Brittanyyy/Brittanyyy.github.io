...
function changeYear(year) {
    var CSVActual = 'bubbleChartActual.csv';
    var CSVBudget = 'bubbleChartbudget.csv';
    if (year === 'Actual') {
        var dataSource = CSVActual;
    } else {
        var dataSource = CSVBudget;
    }
    ...
    d3.csv(dataSource, function(error, data) {
        ...
        function showPopover(d) {
            $(this).popover({
                ...
                html: true,
                content: function() {
                    return "Assessment ID: " + d.objectName + "</br>Schools: " + d.School + "</br>Others: " + d.Others;
                }
            });
            $(this).popover('show');
        }
